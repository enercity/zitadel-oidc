> [!INFO]
> This repo was forked to be able to extend this software it with triPica support.
> See the branches if you are interested.
> Since this never worked, and is currently not required, let's archive this repo.
